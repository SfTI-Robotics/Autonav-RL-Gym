...
if __name__ == '__main__':
    ...
    for ep in range(load_ep, MAX_EPISODES, 1):
        ...
        for step in range(MAX_STEPS):
            ...
            next_state, reward, done, goal_hit = env.step(action, past_action)
	   ...
	   # print("Reward = " + str(reward))
	    ...
	    if ram.len == 4000 and is_training and not is_loading:
		print("Training!")
		for i in range(1000):
		    trainer.optimizer()
		...
		#print("train")
            ...
            if done or goal_hit or step == MAX_STEPS-1:
        ...
        gc.collect()
        env.logEpisode(rewards_current_episode, done, goal_hit, step_count)
